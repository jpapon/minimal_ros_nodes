#ifndef PCL_TRACKING_COMBINED_COHERENCE_H_
#define PCL_TRACKING_COMBINED_COHERENCE_H_
...
namespace pcl
{
  namespace tracking
  {
    ...
    class CombinedCoherence: public PointCoherence<PointInT>
    {
      public:
        ...
        inline void 
        setDistWeight (double weight) { dist_weight_ = weight; }
...
#include <tracker/impl/combined_coherence.hpp>
